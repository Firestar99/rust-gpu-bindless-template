...
use rust_gpu_bindless::descriptor::{
    ...
    BindlessInstance, DescriptorCounts, MutDescBufferExt, RCDescExt,
};
...
async fn test_simple_compute(bindless: &Bindless) -> anyhow::Result<()> {
    ...
    let pipeline =
        bindless.create_compute_pipeline(crate::shader::simple_compute::simple_compute::new())?;
